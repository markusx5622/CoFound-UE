  ...
  return (
    <div className="min-h-screen bg-zinc-50 py-16 px-6">
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-zinc-100">
        ...
        <h1 className="text-4xl font-extrabold text-zinc-950 mb-4 tracking-tight">Aviso Legal</h1>
        <p className="text-zinc-500 mb-10 pb-6 border-b border-zinc-100">Última actualización: 17 de Junio de 2026</p>

        <div className="space-y-8 text-zinc-600 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">1. Datos Identificativos</h2>
            <p>
              En cumplimiento con el deber de información recogido en artículo 10 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSI-CE), se hace constar que esta plataforma web ha sido desarrollada por el equipo de M&C Web Solutions, operando bajo el nombre de proyecto universitario <strong>CoFound UE</strong>.
            </p>
            <ul className="list-disc pl-5 mt-4 space-y-2">
              <li><strong>Denominación del proyecto:</strong> CoFound UE</li>
              <li><strong>Email de contacto:</strong> contacto@cofoundue.com</li>
              <li><strong>Ubicación orientativa:</strong> Campus Universitario, Universidad Europea</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">2. Usuarios y Condiciones Generales</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">3. Uso del Portal</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">4. Propiedad Intelectual e Industrial</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">5. Exclusión de Garantías y Responsabilidad</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">6. Modificaciones</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">7. Legislación Aplicable y Jurisdicción</h2>
            <p>
