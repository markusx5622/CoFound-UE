  ...
  return (
    <div className="min-h-screen bg-zinc-50 py-16 px-6">
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-zinc-100">
        ...
        <h1 className="text-4xl font-extrabold text-zinc-950 mb-4 tracking-tight">Política de Cookies</h1>
        ...
        <div className="space-y-8 text-zinc-600 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">3. Consentimiento</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">4. Revocación y eliminación de cookies</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">5. Modificaciones en la Política de Cookies</h2>
            <p>
