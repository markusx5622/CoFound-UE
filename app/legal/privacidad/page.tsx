...
export default function PoliticaPrivacidad() {
  return (
    <div className="min-h-screen bg-zinc-50 py-16 px-6">
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-zinc-100">
        <Link 
          href="/" 
          className="inline-flex items-center gap-2 text-zinc-500 hover:text-[#E60000] transition-colors mb-8 text-sm font-medium"
        >
          <ArrowLeft className="w-4 h-4" />
          Volver a inicio
        </Link>
        
        <h1 className="text-4xl font-extrabold text-zinc-950 mb-4 tracking-tight">Política de Privacidad</h1>
        <p className="text-zinc-500 mb-10 pb-6 border-b border-zinc-100">Última actualización: 17 de Junio de 2026</p>

        <div className="space-y-8 text-zinc-600 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">1. Información al Usuario</h2>
            <p>
              El equipo detrás de <strong>CoFound UE</strong> (en adelante, el RESPONSABLE), es el Responsable del tratamiento de los datos personales del Usuario y le informa de que estos datos serán tratados de conformidad con lo dispuesto en el Reglamento (UE) 2016/679 de 27 de abril de 2016 (GDPR) relativo a la protección de las personas físicas en lo que respecta al tratamiento de datos personales y a la libre circulación de estos datos.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">2. Finalidad del Tratamiento de los Datos</h2>
            <p>
            ...
            <ul className="list-disc pl-5 mt-4 space-y-2">
              <li><strong>Gestión de Usuarios:</strong> Para identificar al usuario mediante su correo institucional de la Universidad Europea y garantizar un entorno cerrado de estudiantes reales.</li>
              <li><strong>Creación de Perfil:</strong> Para permitir la publicación y búsqueda de proyectos de emprendimiento dentro del ecosistema universitario.</li>
              <li><strong>Comunicación:</strong> Para gestionar notificaciones, interacciones, solicitudes de match y correos electrónicos de carácter informativo sobre la actividad del usuario en la plataforma.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">3. Base Legitimadora del Tratamiento</h2>
            <p>
              La base legal para el tratamiento de los datos es el <strong>consentimiento expreso</strong> del usuario. El registro en la plataforma CoFound UE y el uso de la misma implican la aceptación de esta Política de Privacidad y el consentimiento inequívoco para que los datos proporcionados sean tratados conforme a las finalidades aquí expuestas.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">4. Criterios de Conservación de los Datos</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">5. Comunicación de los Datos</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">6. Derechos del Usuario</h2>
            <p>
            ...
            <p className="mt-4">
              Para ejercer cualquiera de estos derechos, el usuario puede enviar una solicitud detallada a nuestro correo electrónico de soporte: <strong>contacto@cofoundue.com</strong>.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-zinc-900 mb-3">7. Medidas de Seguridad</h2>
            <p>
