        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 relative">
          ...
          {steps.map((step, idx) => (
            <div key={idx} className="relative z-10 flex flex-col items-center text-center group">
              {/* Círculo del Icono */}
              <div className="w-16 h-16 rounded-2xl bg-zinc-900 border border-zinc-800 flex items-center justify-center mb-6 group-hover:border-[#E60000]/60 transition-all duration-300 shadow-xl group-hover:shadow-[0_0_20px_rgba(230,0,0,0.1)] relative">
                {step.icon}
